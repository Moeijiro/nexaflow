...
untrusted input, and an engine that can evaluate code is the wrong tool for
rendering it. Missing paths render empty and are reported, so a typo shows up
in the execution log instead of silently becoming "None".
"""
